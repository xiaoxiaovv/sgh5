 ...
 * describe：AccountMessageController 测试控制器
 **/

APP.controller('AccountMessageController', ['$scope', 'AccountMessageService', '$rootScope', '$state', '$ionicActionSheet', '$timeout', 'UserService', '$ionicLoading', 'PlatformService', 'ionicDatePicker', '$ionicPopup', 'LoginService','$localstorage',
  function ($scope, AccountMessageService, $rootScope, $state, $ionicActionSheet, $timeout, UserService, $ionicLoading, PlatformService, ionicDatePicker, $ionicPopup, LoginService,$localstorage) {
 ...
 **/
APP.service('AccountMessageService', ['$http', 'UrlService',
