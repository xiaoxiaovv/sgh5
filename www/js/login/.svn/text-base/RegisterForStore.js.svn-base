 ...
 * describe：注册控制器
 **/
APP.controller('RegisterForStoreController', ['$localstorage','$scope', 'RegisterService', 'PopupService', '$interval', '$state', 'LoginService',
  'UserService', 'ShopService', '$ionicPopup', 'AccountMessageService', '$ionicLoading', '$timeout', '$ionicHistory', '$stateParams','$rootScope','InAppBrowserService','UrlService',
  function ($localstorage,$scope, RegisterService, PopupService, $interval, $state, LoginService, UserService, ShopService,
            $ionicPopup, AccountMessageService, $ionicLoading, $timeout, $ionicHistory, $stateParams,$rootScope,InAppBrowserService,UrlService) {
