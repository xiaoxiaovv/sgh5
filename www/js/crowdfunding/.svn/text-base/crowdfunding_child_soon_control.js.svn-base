 ...
 */
                          // 即将上线
APP.controller('crowdfunding_child_soon_control', ['$scope', 'CrowdFundingServer_soon', '$timeout','UserService','GoodsService','CommonAddressService',
...
APP.service('CrowdFundingServer_soon', ['$http', 'UrlService', function ($http, UrlService) {
  // 图片轮播
  this.bannerList=function () {
    return $http.get(UrlService.getZCUrl('ZC_INDEX'));
  }
