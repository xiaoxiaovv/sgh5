...
var krpanoplugin = function()
{
	...
	var shader_passes = 2;		// the more the higher the quality at larger blur settings - need to be a multiple of 2
	var shaders = null;
    ...
    plugin.action_enable_blur = action_enable_blur;
    plugin.action_disable_blur = action_disable_blur;
	}
	...
	{
    console.log("api_blur_set " + value);
		// convert to number
		value = Number(value);
  ...
  function action_enable_blur(){
    api_blur_set(3);
  }
  
  function action_disable_blur(){
    api_blur_set(0);
  }
}
